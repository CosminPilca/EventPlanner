...
import { hashPasswordClient, validatePasswordStrength } from '@/lib/client-crypto'
...
export default function SignUpForm() {
    ...
    const validateForm = () => {
        ...
        if (!formData.password) {
            ...
            newErrors.password =
                'Password must be at least 6 characters long and contain lowercase, uppercase, and numeric characters'
        }
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            //@ts-ignore
            await register(formData.email, hashedPassword, formData.name.trim(), true)
        } catch (error) {
            setErrors({
                submit:
