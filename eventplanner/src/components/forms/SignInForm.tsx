...
import { hashPasswordForLogin } from '@/lib/client-crypto'
...
export default function SignInForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const hashedPassword = await hashPasswordForLogin(formData.password, formData.email)

            // @ts-ignore
            await login(formData.email, hashedPassword, true)
