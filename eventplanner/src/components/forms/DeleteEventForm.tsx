                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full mx-4">
                        <div className="text-center">
                            ...
                            <h3 className="text-lg font-medium text-gray-900 mb-2">Event Deleted Successfully!</h3>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
                                        <div>
                                            <div className="flex items-center mb-2">
                                                ...
                                                <strong>Starts:</strong> {formatDateTime(selectedEvent.startsAt)}
                                            </div>
                                            <div className="flex items-center mb-2">
                                                <svg className="w-4 h-4 mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3a4 4 0 118 0v4m-4 9v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z"></path>
                                                </svg>
                                                <strong>Ends:</strong> {formatDateTime(selectedEvent.endsAt)}
                                            </div>
                                        </div>
                                        <div>
                                            <div className="flex items-center mb-2">
                                            ...
                                            <div className="flex items-center mb-2">
                                                ...
                                                <strong>Organizer:</strong> {selectedEvent.organizer.name || selectedEvent.organizer.email}
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="px-8 py-6">
                    {events.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-500">There are no events to delete at the moment.</p>
                        </div>
                    ) : (
