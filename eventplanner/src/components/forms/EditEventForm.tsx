...
export default function EditEventsForm({ events, categories, admins }: EditEventsFormProps) {
        ...
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full mx-4">
                        <div className="text-center">
                            ...
                            <h3 className="text-lg font-medium text-gray-900 mb-2">Event Updated Successfully!</h3>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
                        <div className="px-8 py-6 border-b border-gray-200 flex justify-between items-center">
                            <h2 className="text-2xl font-bold text-gray-900">Edit Event: {selectedEvent.title}</h2>
                            <button
                                onClick={closeModal}
                        ...
                        <form action={handleSubmit} className="px-8 py-6 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label htmlFor="startsAt" className="block text-sm font-semibold text-gray-900 mb-2">
                                        Starts At
                                    </label>
                                    <input
                                        type="datetime-local"
                                ...
                                <div>
                                    <label htmlFor="endsAt" className="block text-sm font-semibold text-gray-900 mb-2">
                                        Ends At
                                    </label>
                                    <input
                                        type="datetime-local"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label htmlFor="organizerId" className="block text-sm font-semibold text-gray-900 mb-2">
                                        Organizer
                                    </label>
                                    <select
                                        id="organizerId"
            ...
            <div className="bg-white rounded-lg shadow-lg">
                <div className="px-8 py-6 border-b border-gray-200">
                    <h2 className="text-3xl font-bold text-gray-900 text-center">Select Event to Edit</h2>
                </div>
                        ...
                        <div className="text-center py-12">
                            <div className="text-gray-400 mb-4">
                                <svg className="w-16 h-16 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M8 7V3a4 4 0 118 0v4m-4 9v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z"></path>
                                </svg>
                            </div>
                            <h3 className="text-lg font-medium text-gray-900 mb-2">No Events Found</h3>
                            <p className="text-gray-500">There are no events to edit at the moment.</p>
                        </div>
                    ) : (
                                    ...
                                    <div className="space-y-2 text-sm text-gray-600">
                                        <div className="flex items-center">
                                            <svg className="w-4 h-4 mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3a4 4 0 118 0v4m-4 9v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z"></path>
                                            </svg>
