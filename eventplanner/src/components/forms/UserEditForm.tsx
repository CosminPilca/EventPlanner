        ...
        <form action={handleSubmit} className="px-8 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                name="title"
                required
                className="w-full px-4 py-3 border rounded-lg theme-transition"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 border rounded-lg theme-transition"
                defaultValue={formatDateForInput(new Date(event.startsAt))}
              />
            </div>
            <div>
              <label
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 border rounded-lg theme-transition"
                defaultValue={formatDateForInput(new Date(event.endsAt))}
              />
            </div>
          </div>
          ...
          <div className="flex justify-center space-x-4 pt-6 border-t border-theme-primary">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="px-8 py-3 font-medium rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-colors disabled:opacity-50"
            >
