...
export default function CreateEventForm({ categories, admins }: CreateEventFormProps) {
        ...
        <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white rounded-lg shadow-lg">
                <div className="px-8 py-6 border-b border-gray-200">
                    <h2 className="text-3xl font-bold text-gray-900 text-center">Create Event</h2>
                </div>
                ...
                <form action={handleSubmit} className="px-8 py-6 space-y-6">
                    ...
                    <div className="flex justify-center space-x-4 pt-6 border-t border-gray-200">
                        <button
                            type="button"
                            className="px-8 py-3 border border-gray-300 rounded-lg text-gray-900 font-medium bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition duration-200 !text-gray-900"
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="px-8 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed !text-white"
                        >
