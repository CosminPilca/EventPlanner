...
export default function UnauthorizedAccess({
    ...
    useEffect(() => {
        ...
        const handlePopState = (event: PopStateEvent) => {
            ...
            alert('Access denied. You cannot return to the previous page due to insufficient permissions.');
        };
                    ...
                    <div className="text-center">
                        ...
                        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-md">
                            <p className="text-xs text-blue-800">
                                <span className="font-semibold">Note:</span> If you believe this is an error,
                                please contact the administrator to verify your permissions.
                        ...
                        {reason.includes('revoked') && (
                            <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-md">
                                <p className="text-xs text-red-800">
                                    <span className="font-semibold">Security Notice:</span> Your access permissions
                                    have been modified. Please sign in again if you need to access protected resources.
                                </p>
                            </div>
                        )}
                    </div>
