                    ...
                    <div className="mb-8">
                        ...
                        <div className="flex items-center text-gray-600 mb-6">
                            <div className="flex items-center">
                                ...
                                <span>Organized by <span className="font-semibold text-gray-900">{event.organizer.name || 'Anonymous'}</span></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-6">
                            <div className="bg-white rounded-xl p-6 shadow-sm border">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <div className="font-semibold text-gray-900 text-sm">Starts</div>
                                            <div className="text-gray-600 text-sm">{formatDate(event.startsAt)}</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <div className="font-semibold text-gray-900 text-sm">Ends</div>
                                            <div className="text-gray-600 text-sm">{formatDate(event.endsAt)}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-xl p-6 shadow-sm border">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="font-semibold text-gray-900 text-sm">{event.organizer.name || 'Anonymous'}</div>
                                        <a
