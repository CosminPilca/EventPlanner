        ...
        <div className="relative flex min-h-screen flex-col bg-white dark:bg-gray-800">
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-3xl mx-auto text-center">
                    <h1 className="text-5xl font-bold tracking-tight sm:text-6xl mb-6 text-gray-900 dark:text-white">
                        Welcome to the  { '  ' }
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center ">
                        <button className="bg-blue-600 hover:bg-blue-700  h-10 px-4 py-2 rounded-md font-medium transition-colors"
                            style={{color: 'white'}}
                        >
