      ...
      <div className="max-w-md w-full text-center">
        <div className="mb-8">
          <div className="relative">
            <div className="text-9xl font-bold text-theme-muted select-none opacity-30">
              404
            </div>
            <div className="absolute inset-0 flex items-center justify-center">
              <div
                className="w-24 h-24 rounded-full flex items-center justify-center theme-transition"
        ...
        <div className="bg-theme-primary rounded-lg shadow-xl p-8 border border-theme-primary theme-transition">
          ...
          <p className="text-theme-secondary mb-6 leading-relaxed">
            Oops! The page you're looking for doesn't exist yet. This feature is
          ...
          <div className="space-y-3">
            <LinkButton href="/admin" variant="primary" size="lg" fullWidth>
              Back to Admin Dashboard
            </LinkButton>

            <div className="flex space-x-3">
              <LinkButton href="/events" variant="secondary" className="flex-1">
                Browse Events
              </LinkButton>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            className="absolute top-1/4 left-1/4 w-4 h-4 rounded-full opacity-60 animate-pulse"
            style={{ backgroundColor: 'var(--color-primary)' }}
          ></div>
          <div
            className="absolute top-3/4 right-1/4 w-6 h-6 rounded-full opacity-40 animate-pulse delay-1000"
            style={{ backgroundColor: 'var(--color-primary)' }}
          ></div>
          <div
            className="absolute bottom-1/4 left-1/3 w-3 h-3 rounded-full opacity-50 animate-pulse delay-500"
            style={{ backgroundColor: 'var(--color-primary)' }}
          ></div>
        </div>
      </div>
