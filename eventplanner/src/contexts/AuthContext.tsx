...
interface AuthContextType {
    user: User | null
    loading: boolean
    login: (email: string, password: string, isPreHashed?: boolean) => Promise<void>
    register: (email: string, password: string, name?: string, isPreHashed?: boolean) => Promise<void>
    logout: () => Promise<void>
    isAdmin: boolean
...
export function AuthProvider({
    ...
    const login = async (email: string, password: string, isPreHashed: boolean = false) => {
        try {
    ...
    const register = async (email: string, password: string, name?: string, isPreHashed: boolean = false) => {
        try {
